	...
	<div class="content-area">
		<div class="header">
			<div class="row">
				...
				<div class="col-md-3"><input id="respondent_name" value="<?php echo $clientReponseEntity["respondent_name"]?>" type="text" class="form-control" placeholder="Enter Name"/></div>
				<div class="col-md-7 text-right">
					<span class="lnr lnr-calendar-full"></span> Modified: <?php echo date("d F, Y",strtotime($clientReponseEntity["date_added"]));?>
					<span class="lnr lnr-user"></span> <?php echo $getClient["client_name"]?>
				</div>
			</div>
			<input id="response_id" type="hidden" value="<?php echo $responseId;?>"/>
		</div>
		<hr/>
